...
type RevisionsOverviewItem struct {
	...
	InternalRevisionSubject *structs.SettingsDropdown `json:"internal_revision_subject"`
	ExternalRevisionSubject *structs.SettingsDropdown `json:"external_revision_subject"`
	Revisor                 structs.SettingsDropdown  `json:"revisor"`
