...
var EnforcedPaymentMutation = graphql.NewInputObject(graphql.InputObjectConfig{
	...
	Fields: graphql.InputObjectConfigFieldMap{
		...
		"account_id_for_expenses": &graphql.InputObjectFieldConfig{
			Type: graphql.Int,
		},
		...
		"amount_for_bank": &graphql.InputObjectFieldConfig{
			Type: graphql.Float,
		},
		"execution_number": &graphql.InputObjectFieldConfig{
			Type: graphql.String,
		},
		"agent_id": &graphql.InputObjectFieldConfig{
			Type: graphql.Int,
		},
