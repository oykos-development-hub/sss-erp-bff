...
// func buildFinancialBudgetResponseItem(ctx context.Context, r repository.MicroserviceRepositoryInterface, financialBudget structs.FinancialBudget, organizationUnitID *int) (*dto.FinancialBudgetResponseItem, error) {
// 	financialBudgetStatus, err := buildFinancialBudgetStatus(ctx, r, financialBudget, organizationUnitID)
// 	if err != nil {
// 		return nil, err
// 	}
// 	return &dto.FinancialBudgetResponseItem{
// 		ID:             financialBudget.ID,
// 		AccountVersion: financialBudget.AccountVersion,
// 		BudgetID:       financialBudget.BudgetID,
// 		Status:         financialBudgetStatus,
// 	}, nil
// }

// func buildFinancialBudgetStatus(ctx context.Context, r repository.MicroserviceRepositoryInterface, financialBudget structs.FinancialBudget, organizationUnitID *int) (string, error) {
...
// 		return "", fmt.Errorf("you must pass the organizationUnitID")
// 	}

// 	filledFinancialList, err := r.GetFilledFinancialBudgetList(*organizationUnitID, financialBudget.ID)
// 	if err != nil {
// 		return "", err
// 	}

// 	if len(filledFinancialList) > 0 {
// 		return "Obrađen", nil
// 	} else {
// 		return "Obradi", nil
// 	}
