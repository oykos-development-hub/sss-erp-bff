...
func SetupGraphQLSchema(notificationService *notifications.NotificationService, repo repository.MicroserviceRepositoryInterface, cfg *config.Config) (*graphql.Schema, error) {
	...
	mutation := graphql.NewObject(graphql.ObjectConfig{
		...
		Fields: graphql.Fields{
			...
			"template_Insert":                                 fields.TemplateInsertField(),
			"template_Update":                                 fields.TemplateUpdateField(),
			"templateItem_Update":                             fields.TemplateItemUpdateField(),
			"template_Delete":                                 fields.TemplateDeleteField(),
			...
			"jobTenderApplications_Insert":                    fields.JobTenderApplicationsInsertField(),
			"jobTenderApplications_Delete":                    fields.JobTenderApplicationsDeleteField(),
			"systematizations_Insert":                         fields.SystematizationInsertField(),
			"systematizations_Delete":                         fields.SystematizationDeleteField(),
			"userProfileBasic_Insert":                         fields.UserProfileBasicInsertField(),
			"userProfile_Update":                              fields.UserProfileUpdateField(),
			"userProfileContract_Insert":                      fields.UserProfileContractInsertField(),
			"userProfileContract_Delete":                      fields.UserProfileContractDeleteField(),
			"userProfileEducation_Insert":                     fields.UserProfileEducationInsertField(),
			"userProfileEducation_Delete":                     fields.UserProfileEducationDeleteField(),
			"userProfileExperience_Insert":                    fields.UserProfileExperienceInsertField(),
			"userProfileExperiences_Insert":                   fields.UserProfileExperiencesInsertField(),
			"userProfileExperience_Delete":                    fields.UserProfileExperienceDeleteField(),
			"userProfileFamily_Insert":                        fields.UserProfileFamilyInsertField(),
			"userProfileFamily_Delete":                        fields.UserProfileFamilyDeleteField(),
			"userProfileForeigner_Insert":                     fields.UserProfileForeignerInsertField(),
			"userProfileForeigner_Delete":                     fields.UserProfileForeignerDeleteField(),
			"userProfileSalaryParams_Insert":                  fields.UserProfileSalaryParamsInsertField(),
			"userProfileSalaryParams_Delete":                  fields.UserProfileSalaryParamsDeleteField(),
			"userProfileEvaluation_Insert":                    fields.UserProfileEvaluationInsertField(),
			"userProfileEvaluation_Delete":                    fields.UserProfileEvaluationDeleteField(),
			"absentType_Insert":                               fields.AbsentTypeInsertField(),
			"absentType_Delete":                               fields.AbsentTypeDeleteField(),
			"userProfileAbsent_Insert":                        fields.UserProfileAbsentInsertField(),
			"userProfileVacation_Insert":                      fields.UserProfileVacationInsertField(),
			"userProfileVacations_Insert":                     fields.UserProfileVacationsInsertField(),
			"userProfileAbsent_Delete":                        fields.UserProfileAbsentDeleteField(),
			"userProfileResolution_Insert":                    fields.UserProfileResolutionInsertField(),
			"userProfileResolution_Delete":                    fields.UserProfileResolutionDeleteField(),
			"revisions_Insert":                                fields.RevisionInsertField(),
			"revisions_Delete":                                fields.RevisionDeleteField(),
			"revisionPlans_Insert":                            fields.RevisionPlansInsertField(),
			"revisionPlans_Delete":                            fields.RevisionPlansDelete(),
			"revision_Insert":                                 fields.RevisionInsert(),
			"revision_Delete":                                 fields.RevisionDelete(),
			"revisionTips_Insert":                             fields.RevisionTipsInsert(),
			"revisionTips_Delete":                             fields.RevisionTipsDelete(),
			"revisionTipImplementation_Insert":                fields.RevisionTipImplementationInsert(),
			"revisionTipImplementation_Delete":                fields.RevisionTipImplementationDelete(),
			...
			"nonFinancialBudget_Update":                       fields.NonFinancialBudgetUpdateField(),
			...
			"financialBudgetActual_Fill":                      fields.FinancialBudgetFillActualField(),
			...
			"accountingEntry_Insert":                          fields.AccountingEntryInsertField(),
			...
			"externalReallocationsSSS_Accept":                 fields.ExternalReallocationSSSAcceptField(),
			"externalReallocationsSSS_Reject":                 fields.ExternalReallocationSSSRejectField(),
		},
	})
	query := graphql.NewObject(graphql.ObjectConfig{
		...
		Fields: graphql.Fields{
			...
			"revisionPlans_Overview":                             fields.RevisionPlansOverview(),
			"revisionPlans_Details":                              fields.RevisionPlansDetails(),
			"revision_Overview":                                  fields.RevisionOverview(),
			"revision_Details":                                   fields.RevisionDetails(),
			"revisionTips_Overview":                              fields.RevisionTipsOverview(),
			"revisionTips_Details":                               fields.RevisionTipsDetails(),
			"revisionTipImplementations_Overview":                fields.RevisionTipImplementationOverview(),
			...
			"passOrderListToFinance":                      fields.PassOrderListToFinance(),
			...
			"currentBudget_Overview":                      fields.CurrentBudgetOverviewField(),
			...
			"nonFinancialBudget_Overview":                 fields.NonFinancialOverviewField(),
			...
			"spendingRelease_Overview":                    fields.SpendingReleaseOverviewField(),
			"spendingRelease_Get":                         fields.SpendingReleaseGetField(),
			...
			"cancelPaymentOrder":                          fields.CancelOrderField(),
			...
			"errorLogs_Overview":                          fields.ErrorLogsOverviewField(),
		},
	})
