...
var RevisionsInsertMutation = graphql.NewInputObject(graphql.InputObjectConfig{
	...
	Fields: graphql.InputObjectConfigFieldMap{
		...
		"revision_type": &graphql.InputObjectFieldConfig{
			Type: graphql.Int,
		},
		"serial_number": &graphql.InputObjectFieldConfig{
			Type: graphql.String,
		},
		"internal_revision_subject": &graphql.InputObjectFieldConfig{
			Type: graphql.Int,
		},
		"external_revision_subject": &graphql.InputObjectFieldConfig{
			Type: graphql.Int,
		},
		"date_of_revision": &graphql.InputObjectFieldConfig{
			Type: graphql.String,
		...
		"revisor": &graphql.InputObjectFieldConfig{
			Type: graphql.Int,
		},
		"file_id": &graphql.InputObjectFieldConfig{
			Type: graphql.Int,
...
var RevisionTipsInsertMutation = graphql.NewInputObject(graphql.InputObjectConfig{
	...
	Fields: graphql.InputObjectConfigFieldMap{
		...
		"stauts": &graphql.InputObjectFieldConfig{
			Type: graphql.String,
		},
